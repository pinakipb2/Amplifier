    ...
    <div className="flex flex-col justify-center items-center">
      <div className="flex justify-center items-center w-2/3 mt-10">
        ...
        <div className="flex w-fit flex-col ml-3">
          ...
          <p className="line-clamp-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent ut aliquet velit. Cras viverra egestas metus vel viverra. Nullam et posuere magna. Ut facilisis velit nibh. Sed ac risus
